...
/**
 * Servlet implementation class FreeboardModifyController
 */
...
public class FreeboardModifyController extends HttpServlet {
     ...
     */
    public FreeboardModifyController() {
        super();
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		if(!dto.getMemberId().equals(request.getSession().getAttribute("sessionMemberId").toString()) && !request.getSession().getAttribute("sessionMemberId").equals("admin")) {
			response.setContentType("text/html;charset=utf-8");
		...
		request.setAttribute("boardname", "자유게시판");
...
//		String saveDir = "D:\\java7\\project\\tclass\\HBLearningPlatform\\src\\main\\webapp\\uploads";
		...
		response.sendRedirect("/freeboard/view?idx=" + idx);
	}
