 ...
 */
@WebServlet("/archive/modify")
@MultipartConfig(
	    fileSizeThreshold = 1024 * 1024 * 1,  // 1MB
	    maxFileSize = 1024 * 1024 * 10,       // 10MB
	    maxRequestSize = 1024 * 1024 * 15     // 15MB
	)
public class ArchiveModifyController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ArchiveModifyController() {
        super();
...
//		String saveDir = "C:\\Users\\Jerry\\Desktop\\java7\\project\\TClass\\HBLearningPlatform\\src\\main\\webapp\\uploads";
		...
		response.sendRedirect("/archive/view?idx=" + idx);
	}
