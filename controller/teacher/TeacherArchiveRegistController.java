...
/**
 * Servlet implementation class TeacherArchiveRegistController
 */
@WebServlet("/teacher/archive/regist")
@MultipartConfig(
	    fileSizeThreshold = 1024 * 1024 * 1,  // 1MB
	    maxFileSize = 1024 * 1024 * 10,       // 10MB
	    maxRequestSize = 1024 * 1024 * 15     // 15MB
	)
public class TeacherArchiveRegistController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeacherArchiveRegistController() {
        super();
...
//		String saveDir = "C:\\Users\\Jerry\\Desktop\\java7\\project\\TClass\\HBLearningPlatform\\src\\main\\webapp\\uploads";
		...
		if (result > 0 && (fileResult >= 0 || files.size()==0)) {
			response.sendRedirect("/course/archive?idx="+courseIdx);
		} else {
