...
/**
 * Servlet implementation class CourseQnaListController
 */
@WebServlet("/course/qna")
public class CourseQnaListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CourseQnaListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<BoardDTO> list = dao.courseBoardList(courseIdx, "07", 10, pageNo);
		int count = dao.count(null, "07", null, courseIdx);
		dao.close();
		...
		request.getRequestDispatcher("/course/courseQnaList.jsp").forward(request, response);
	}
