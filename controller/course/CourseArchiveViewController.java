 ...
 */
@WebServlet("/course/archive/view")
public class CourseArchiveViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CourseArchiveViewController() {
        super();
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		request.getRequestDispatcher("/course/courseArchiveView.jsp").forward(request, response);
