...
/**
 * Servlet implementation class CourseArchiveListController
 */
@WebServlet("/course/archive")
public class CourseArchiveListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CourseArchiveListController() {
        super();
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		List<BoardDTO> list = dao.courseBoardList(courseIdx, "06", 10, pageNo);
		int count = dao.count(null, "06", null, courseIdx);
		dao.close();
		...
		request.getRequestDispatcher("/course/courseArchive.jsp").forward(request, response);
