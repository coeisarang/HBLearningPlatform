	...
	<div class="body2">
 	...
 	<div class="container">
        ...
        <div class="main-content">
            <h1>회원 관리</h1>
						<form method="get" name="search" id="search" action="/admin/member">
						<select name="memType">
							<option value="p">학생</option>
                ...
                <tbody>
                    <c:forEach items="${list}" var="item" >
											<tr>
												...
												<td><a href="/admin/member/modify?id=${item.memberId}">${item.name}</a></td>
												<td>${item.school}${item.grade }</td>
												<td>${item.regDate }</td>
												<td><button onclick="location.href='/admin/member/delete?id=${item.memberId}'">강퇴</button></td>
											</tr>
										</c:forEach>
                </tbody>
            </table>
