...
<!-- 헤더 -->
            ...
            <div class="inquiry-form">
                ...
                <form action="#" method="post" onsubmit="validateAgreement(event)">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="content" name="content" rows="6" placeholder="문의내용을 입력해주세요." required></textarea>
                    </div>
    ...
    <script>
        function validateAgreement(event) {
            const agreementYes = document.querySelector('input[name="agreement"][value="yes"]');
            const agreementNo = document.querySelector('input[name="agreement"][value="no"]');

            if (agreementNo.checked) {
                event.preventDefault(); // Prevent form submission
                alert("정보 제공 동의가 필요합니다.");
            }
        }
    </script>
