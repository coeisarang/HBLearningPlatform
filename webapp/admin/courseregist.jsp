    ...
    <div class="body2">
        ...
        <div class="container">
            ...
            <div class="inquiry-form">
                <h1>강좌 등록</h1>
                <form action="/admin/course/regist" method="post" onsubmit="validateAgreement(event)">
                
                	 <div class="form-group">
                        <label for="title">강좌 제목<span class="required">*</span></label>
                        <input type="text" id="title" name="title" placeholder="강좌 제목" required>
                    </div>
                	
                    <div class="form-group">
                        <label for="teacherId">선생님 아이디<span class="required">*</span></label>
                        <input type="text" id="teacherId" name="teacherId" placeholder="선생님 아이디" required>
                    </div>                   
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="detail" name="detail" placeholder="강좌 설명" required>
                    </div>
