...
<c:choose>
	...
	<div class="tabs">
        ...
        <div class="tab" onclick="location.href='/course/lesson?idx=${item.courseIdx}'">강의목차</div>
                <div class="tab active" onclick="location.href='/course/notice?idx=${item.courseIdx}'">공지사항</div>
	...
	<div class="container">
		...
		<div class="content">
			...
			<!-- 게시글에 대한 내용 -->
			${item.content}
			<!--             <p>수능 전날, 수특 150, 수완 36편이나 되는 작품 다 볼 거야? 자료가 넘쳐 나는 시대! 수능 D-50, 시기에 맞는 공부를 해야지! </p> -->
			<!--             <p>끝날 때까지 끝난 게 아니다. 시간은 우리의 편이다.</p> -->
			<!--             <p>응원할게 ❤️</p> -->

		</div>

		<div class="button-container">
			<button onclick="location.href='/course/notice?idx=1'" >목록</button>
		</div>
	</div>
