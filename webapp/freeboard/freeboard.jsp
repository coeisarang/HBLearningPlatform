	...
	<div class="body2">
 	...
 	<div class="container">
        ...
        <div class="main-content">
            ...
            <div class="summary">
                <p>총 게시물 <span>${count }</span> <button style="display:inline-block;" onclick="location.href='/${first}/regist'">글쓰기</button></p>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>${loop.count }</td>
                        <td><a href="/${first}/view?idx=${item.idx }">${item.title }</a></td>
                        <td>${item.regDate }</td>
                        <td>${item.readCnt }</td>
                    </tr>
                    </c:forEach>
