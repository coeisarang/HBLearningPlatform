...
<c:choose>
    ...
    <div style="display: flex;">
        ...
        <!-- 오른쪽 메인 컨텐츠 -->
        <div class="container2" style="flex: 1; padding-left: 20px;">
            <h1>작성 댓글</h1>

            <div class="lecture-list-header">
                <span>댓글 수 ${count}</span> <!-- 댓글 수를 표시합니다 -->
            </div>
            ...
            <div class="container">
                ...
                <c:forEach var="p" items="${pList}">
                    <div class="list-item">
                        <div class="item-info">
                            <h3><a href="/freeboard/view?idx=${p.boardIdx}">댓글 내용: ${p.content}</a></h3>
                ...
                <c:if test="${empty pList}">
                    <div class="lecture-empty">
                        <img src="https://cdn-icons-png.flaticon.com/512/83/83562.png" alt="댓글 내역 없음 아이콘">
                        <p>댓글 내역이 없습니다.</p>
                    </div>
                </c:if>
